...
def getAcqData():
    ...
    for fname in os.listdir("Data/BreastDCEDL_spy1/spt1_dce"):
...
def stackPhases(pid,acqData):
    ...
    volumes = []
    for acq in acqs:
        img:nib.nifti1.Nifti1Image = nib.load(f"Data/BreastDCEDL_spy1/spt1_dce/{pid}_spy1_vis1_acq{acq}.nii.gz")
        data = img.get_fdata()
