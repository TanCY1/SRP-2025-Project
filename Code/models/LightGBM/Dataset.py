...
class ModelDataset(Dataset):
    def __init__(self, metadata:pd.DataFrame,class_samples:dict={0.0:1,1.0:1},loading_bar=True,caching=False,cache_dir=None):
        self.df = metadata
    ...
    def __getitem__(self, idx):
        ...
        mols = torch.tensor(self.df.loc[pid,["ER","PR","HER2"]].to_numpy(),dtype=torch.float32)
