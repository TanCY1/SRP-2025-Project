...
class ResBlock_with_SE(nn.Module):
...
class ResNet(nn.Module):
    def __init__(self,in_channels,):
        ...
        self.layer1 = nn.Sequential(
            ResBlock_with_SE(16,16,stride=1),
            ResBlock_with_SE(16,16,stride=1)
        )
        self.layer2 = nn.Sequential(
            ResBlock_with_SE(16,32,stride=(1,2,2)),
            ResBlock_with_SE(32,32,stride=1)
        )
        self.layer3 = nn.Sequential(
            ResBlock_with_SE(32,64,stride=(1,2,2)),
            ResBlock_with_SE(64,64,stride=1)
        )
        self.layer4 = nn.Sequential(
            ResBlock_with_SE(64,128,stride=(1,2,2)),
            ResBlock_with_SE(128,128,stride=1)
        )
